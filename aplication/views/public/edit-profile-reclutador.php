       ...
       <div id="avatar-section">
        ...
        <form action="" method="post" enctype="multipart/form-data" id="form-datos">
            <div class="registro-form">
                ...
                <label for="empresa" class="labelsito">Empresa</label>
                <input type="text" name="empresa" id="" placeholder="Actualiza el Nombre de Empresa" class="input-form">
                <label for="rfc" class="labelsito">RFC</label>
                <input type="text" name="rfc" id="" placeholder="Actualiza tu RFC" class="input-form">
            </div>
            ...
            <div class="registro-form">
                ...
                <label for="direccion" class="labelsito">Direccion empresa</label>
                <input type="text" name="direccion" id="" placeholder="Disponible" class="input-form">
